...
.product-container {
            width: 100px;
            height: 100px;
            border-radius: 50%; /* Điều này làm tròn các góc */
            overflow: hidden; /* Đảm bảo hình tròn không bị bóp */
            border: 2px solid #ccc; /* Viền ô */
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Bóng đổ nhẹ */
            position: relative; /* Để căn giữa nội dung bên trong */
        }

        /* CSS để căn giữa nội dung bên trong ô hình tròn */
        .product-content {
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        .product-image img {
            width: 100%;
            height: 100%;
            object-fit: cover; /* Đảm bảo hình ảnh đầy đủ không bị biến đổi tỷ lệ */
        }
</style>
...
<div id="carouselExample" class="carousel slide">
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExample" data-bs-slide="prev">
    <span class="carousel-cont-prev-icon #333rol-prev-icon" aria-hidden="true"></span>
...
<div class="sale" style="margin-bottom: 10px; margin-top:30px">
    <h3 class="" style="margin-left: 220px ;margin-bottom:40px;">New Clothing</h3>
</div>
...
<div class="row" style="margin-bottom: 10px;" >
    ...
    foreach($sphome1 as $sp) {
        echo '<div class="col">
                ...
                <input type="hidden" value="'.$sp['ten_hh'].'" namez="ten_hh">
...
<div class="sale" style="margin-bottom: 10px; margin-top:30px">
<h3 class=""style="margin-left: 45px ;margin-bottom:40px;">Sale</h3>
</div>
...
<h3 class="" style="margin-left: 215px ;margin-bottom:40px;">Hot</h3>
